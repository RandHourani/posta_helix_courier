          ...
          if(snap.hasData)
            {    if (snap.data.data.data.isEmpty) {
              return StreamBuilder(
                stream: onlineOfflineBloc.captainStatus, builder: (BuildContext context, AsyncSnapshot<bool> snapshot) {
                if(snapshot.hasData)
                {if(snapshot.data)
                {return Stack(
                  children: [
                                  ...
                                  if (snapshot.hasData) {
                                    ...
                                    return SafeArea(
                                      child: Align(
                                          ...
                                          child: InkWell(
                                              onTap: () {
                                                onlineOfflineBloc.setOfflineStatus(false);
                                                onlineOfflineBloc.setStatus(false);
                                                ...
                                                if (snapshot.hasData) {
                                                  ...
                                                  { if (snapshot.data.data.bookings[0].order
                                                    ...
                                                    return StreamBuilder(
                                                      ...
                                                      .bookings[0].order.cashOnDeliveryOption=="RETURN") {
                                                    return StreamBuilder(
                                                      stream: orderBloc.orderSheet,
                                                      builder: (BuildContext context,
                                                          AsyncSnapshot<String>
