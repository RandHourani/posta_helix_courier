...
class VehicleDetailsScreen extends StatelessWidget {
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: Column(children: <Widget>[
                                       ...
                                       builder: (context,
                                         ...
                                         if (snap.hasData) {
                                           ...
                                           return  InkWell(
                                             ...
                                             child: StreamBuilder(
                                               stream: vehicleBloc.selectedModel,
                          ...
                          Container(
                            ...
                            child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  //   builder: (context,
                                  //       AsyncSnapshot<CityModel> snap) {
                                  //     if (snap.hasData) {
                                  //       List<String> list = List();
                                  //       for (int i = 0;
                                  //           i < snap.data.data.length;
                                  //           i++) {
                                  //         list.add(snap.data.data[i].nameEN
                                  //             .toString());
                                  //       }
                                  //
                                  //       return PopupMenuButton<String>(
                                          ...
                                          return PopupMenuButton<String>(
                                            ...
                                            child: StreamBuilder(
                                              ...
                                              builder: (context, snap) {
                                                ...
                                                {if(list[0]==null)
                                                  { countryBloc.getCities(signInBloc.getCountryCode());}
                                                  else
                                                    {}
                                                  return Row(
                                                    mainAxisSize:
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                StreamBuilder(
                                  stream: vehicleBloc.registrationExpiredDate,
                                  builder: (context, snap) {
                                    if (snap.hasData) {
                                      return InkWell(
                                        onTap: () {
                          ...
                          StreamBuilder(
                            stream:
                                vehicleBloc.registrationExpireDateValidation,
                            ...
                            onPressed: () {
                              TextFieldValidation()
                                  .checkRegistrationExpiredDateValidation(
                                      vehicleBloc.getRegistrationExpireDate());
  ...
  carBrandTextField(context) {
    ...
    if (captainPersonalData != null) {
      vehicleBloc.setBrandId(captainPersonalData.data.car.carBrandId);
      _typeAheadController.text = captainPersonalData.data.car.carBrandName;
      vehicleBloc.fetchAllCarModels();
    } else {}
