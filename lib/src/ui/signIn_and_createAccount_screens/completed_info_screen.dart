                      ...
                      onPressed: () {
                        showDialog(
                                ...
                                builder: (BuildContext context) {
                                  ...
                                  return _showAppointmentDetailsDialog(context);
                                })
                            .then((value) =>
                                FlutterStatusbarcolor.setStatusBarColor(
                                    Colors.white));
                              ...
                              Row(
                                children: [
                                  Padding(
                                    ...
                                    Text(
                                      convertDay(snapshot.data.data.interview.dateTime),
                                      style: TextStyle(
                                          color: AppColors.labelColor,
                                          fontFamily: 'Poppins'),
                                    ),
                                  ...
                                  Text(
                                    convertDateDisplay(
                                        snapshot.data.data.interview.dateTime),
                                    style: TextStyle(
                                        color: AppColors.labelColor,
                                        fontFamily: 'Poppins'),
                                  )
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                  padding: EdgeInsets.only(left: 20, right: 6),
                                  child: Text(
                                    interviewBloc.getSelectedTime(snapshot.data.data.interview.dateTime).toString(),
                                    style: TextStyle(
                                        color: AppColors.labelColor,
                                        fontFamily: 'Poppins'),
                                  ))
