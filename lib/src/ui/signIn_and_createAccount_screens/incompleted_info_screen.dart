                                            ...
                                            children: [
                                                  ...
                                                  if(snapshot.hasData){
                                                    return   Container(
                                                      margin: EdgeInsets.only(
                                                          ...
                                                          bottom: 4),
                                                      decoration: BoxDecoration(
                                                          color: snapshot.data?AppColors.COMPLETED_INFO_BOX:AppColors.ERROR,
                                              ...
                                              Container(
                                                ...
                                                child: DottedLine(
                                                  ...
                                                  lineThickness: 3,
                                                  dashRadius: 50,
                                                  dashColor: Color(0xffEFEFEF),
                                                ),
                                              ),
                                              StreamBuilder(
                                                stream:
                                                checkCaptainDataBloc.vehicle,
                                                builder: (BuildContext context,
                                                    AsyncSnapshot<bool>
                                                    snapshot) {
                                                  if(snapshot.hasData){
                                              ...
                                              StreamBuilder(
                                                stream:
                                                checkCaptainDataBloc.documents,
                                                builder: (BuildContext context,
                                                    AsyncSnapshot<bool>
                                                        snapshot) {
                                                  if(snapshot.hasData){
                                                    ...
                                                    builder:
                                                      ...
                                                      return InkWell(
                                                        onTap: () {
                                                          ...
                                                          personalDetailsBloc
                                                              .setNationality(snapshot.data.data.nationalityId);
                                                ...
                                                children: [
                                                  ...
                                                  StreamBuilder(
                                                    ...
                                                    builder:
                                                      ...
                                                      return InkWell(
                                                        onTap: () {
                                                          if(snapshot.data.data.car!=null){
                                                          vehicleBloc.getSuggestions(snapshot.data.data.car.carBrandName);
                                                          vehicleBloc.findCarBrand(snapshot.data.data.car.carBrandName,snapshot.data.data.car.carBrandId);
                                                          vehicleBloc
                                                              .setRegistrationExpireDate(
                                                              Utils.dateTimeFormat2(
                                                                  snapshot
                                                                      .data
                                                                      .data.car.insuranceExpiredDate));
                                                          Navigator.push(
                                                            context,
                                                            MaterialPageRoute(
                                                                builder:
                                                ...
                                                children: [
                                                  ...
                                                  StreamBuilder(
                                                    ...
                                                    builder:
                                                      ...
                                                      return InkWell(
                                                        onTap: () {
                                                         if(snapshot.data.data.drivingCertificateF!=null)
                                                       {   Navigator.push(
                                                            context,
                                                            MaterialPageRoute(
                                                                builder:
